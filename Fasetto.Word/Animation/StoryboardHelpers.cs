...
namespace Fasetto.Word
{
    public static class StoryboardHelpers
    {
        ...
        public static void AddSlideToLeft(this Storyboard storyboard, float secounds, double offset, float decelerationRatio = 0.9f)
        {
        ...
        public static void AddSlideFromRight(this Storyboard storyboard, float secounds, double offset, float decelerationRatio = 0.9f)
        {
            var animation = new ThicknessAnimation
            {
                Duration = new Duration(TimeSpan.FromSeconds(secounds)),
